...
2. Set "GoScene" as the skill name and "scene" as the invocation name, this is what is used to activate your skill. For example you would say: "Alexa, run Scene to Bravo."
